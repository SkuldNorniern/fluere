...
use crate::net::parser::{protocol_to_number,parse_ports};
...
fn ipv4_keys(packet: Ipv4Packet)->Result<(IpAddr,IpAddr,u16,u16,u8),NetError>{
    ...
    Ok((std::net::IpAddr::V4(src_ip), std::net::IpAddr::V4(dst_ip), src_port, dst_port, protocol))
}
...
fn ipv6_keys(packet: Ipv6Packet)->Result<(IpAddr,IpAddr,u16,u16,u8),NetError>{
    ...
    Ok((std::net::IpAddr::V6(src_ip), std::net::IpAddr::V6(dst_ip), src_port, dst_port, protocol))
}