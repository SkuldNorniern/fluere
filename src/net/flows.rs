...
pub fn packet_parser_v5(packet: Packet) {
    println!("Packet: {:?}", packet.data[0]);
    let _packet_header = packet.header;
    let _packet_data = packet.data;
...
mod tests {
    ...
    fn packet_parser_v5() {
        ...
        packet_parser_v5(packet);
        println!("Netflow: {:?}", netflow);
        panic!();
    }
}
